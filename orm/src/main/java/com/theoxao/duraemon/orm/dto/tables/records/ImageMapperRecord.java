...
public class ImageMapperRecord extends UpdatableRecordImpl<ImageMapperRecord> implements Record6<String, Integer, String, LocalDateTime, Integer, Short> {
     ...
     */
    public void setDownload(Short value) {
        set(5, value);
    }
    ...
    @Override
    public Row6<String, Integer, String, LocalDateTime, Integer, Short> valuesRow() {
    ...
    @Override
    public ImageMapperRecord value6(Short value) {
        setDownload(value);
        return this;
    }

    @Override
    public ImageMapperRecord values(String value1, Integer value2, String value3, LocalDateTime value4, Integer value5, Short value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ImageMapperRecord(String uuid, Integer oid, String imageUrl, LocalDateTime insertTime, Integer type, Short download) {
        super(ImageMapper.IMAGE_MAPPER);

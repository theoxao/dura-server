...
public class TbGoodCandidateRecord extends UpdatableRecordImpl<TbGoodCandidateRecord> implements Record6<String, String, String, Integer, Integer, Integer> {
    ...
    @Override
    public Row6<String, String, String, Integer, Integer, Integer> valuesRow() {
    ...
    @Override
    public TbGoodCandidateRecord values(String value1, String value2, String value3, Integer value4, Integer value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TbGoodCandidateRecord(String id, String name, String from, Integer cate, Integer subCate, Integer count) {
        super(TbGoodCandidate.TB_GOOD_CANDIDATE);

...
public class TbGoodsRecord extends UpdatableRecordImpl<TbGoodsRecord> implements Record11<Integer, String, String, Integer, Integer, Integer, Integer, JSON, Integer, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row11<Integer, String, String, Integer, Integer, Integer, Integer, JSON, Integer, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public TbGoodsRecord values(Integer value1, String value2, String value3, Integer value4, Integer value5, Integer value6, Integer value7, JSON value8, Integer value9, LocalDateTime value10, LocalDateTime value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TbGoodsRecord(Integer id, String name, String desc, Integer cate, Integer subCate, Integer remainBatch, Integer recentPrice, JSON images, Integer needBuy, LocalDateTime createTime, LocalDateTime updateTime) {
        super(TbGoods.TB_GOODS);
